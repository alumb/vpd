# Authors:  
#   - UP EEE Computer Networks Laboratory
#   - Darwin M. Bautista <djclue917@gmail.com>
#   - Andy Lumb <andy.lumb@gmail.com>
#
        ...
        if not isinstance(args, (list, tuple)):
            ...
            for arg in args:
                if not isinstance(arg, basestring):
                    raise TypeError("args should either be a tuple or list of strings")
        self._args = ['-slave', '-idle', '-quiet', '-nojoystick', '-nolirc', '-vo', 'xv,x11,']
...
class Server(asyncore.dispatcher):
    ...
    def __init__(self, host='', port=PORT, max_conn=1):
        ...
        self._mplayer.handle_data = self._mplayer.handle_error = self.log
